                ...
                <div className="row">
                    <div className="col-lg-8 col-xl-9 mb-4">
                        <div className="border-left border-md mb-3">
                            <p className="font-family-condensed letter-spacing-lg lead m-0 p-3">Я предприниматель</p>
                            <div className="card-group flex-column flex-md-row">
                                <div className="card">
                                    <div className="card-body py-0">
                                        <h5 className="card-title mb-0">В США будут решать, возобновить ли работу
                                            предприятий в условиях коронавируса</h5>
                                    </div>
                                    <div className="card-footer">
                                        <small className="text-muted font-family-condensed">20:10 сегодня</small>
                                    </div>
                                </div>
                                <div className="card">
                                    <div className="card-body py-0">
                                        <h5 className="card-title mb-0">Коронавирус рекордно подорвал деловую активность
                                            в Европе</h5>
                                    </div>
                                    <div className="card-footer">
                                        <small className="text-muted font-family-condensed">20:10 сегодня</small>
